...
<div class="container">
	<div class="row">
    	...
    	<div class="col-xl-8 col-md-8" style="border-right:solid; border-left:solid;"><br><br>
        	<table width="100%" cellspacing="0" cellpadding="0" id="login"  style="text-align:center;">
      <tr >
      ...
      <tr>
        <td><input name="pass" type="password" required style="width:70%" placeholder="Password "></input><br><br></td>
      </tr>
      <tr>
