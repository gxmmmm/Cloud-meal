                    ...
                    <div class="col-lg-3 offset-lg-1" style="border:solid;"><br>
                    	<div class="media contact-info">
                    		<div class="media-body">
                            	<img src="img/Coffee.jpg" class="img-fluid rounded-circle">
                                <h1 align="center">ร้านDouble Coffee</h1>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-home"></i></span>
                            <form action="rez11s.php" method="post" name="1.s">
                            <div class="media-body">
                                <h3>ชื่อผู้สั่ง</h3>
